...
At this point, the user needs to use the [profiling template](https://github.com/cytomining/profiling-template) to use the [jump branch of pycytominer](https://github.com/cytomining/pycytominer/tree/jump) to create aggregated profiles, annotate them with metadata, normalize them, and feature select them.  Detailed instructions for these steps will be added as soon as possible.
