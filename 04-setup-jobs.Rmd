...
Troubleshooting: Check the `pipeline` and `data_file` variables in the `dcp_config.json` file to ensure that they look right. They should be assigned relative paths e.g. `projects/XXX/XXX/...`, not absolute paths. This can happen if the `PIPELINE_SET` variable is not set correctly.
