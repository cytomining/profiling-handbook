...
> _TODO: Maybe clarify that users should have an S3 bucket and EFS set up already?_
...
> _TODO: Clarify what we mean by "AWS infrastructure setup" here. Is it the config below? Or the cytominer_ami.json file in the VM?_
...
> _TODO: Clarify what changes need to be made to allow mounting from a different region because users are unlikely to have used Terraform_
